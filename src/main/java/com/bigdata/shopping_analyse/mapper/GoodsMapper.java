...
public interface GoodsMapper {
	...
	int count();
	@Select("select goods_id_key,goods_name,goods_price,goods_num,goods_type,create_id,create_time,uppdate_id,update_time from goods_info where goods_info.goods_id_key = #{id}")
